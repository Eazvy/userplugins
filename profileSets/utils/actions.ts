...
type PresetUpdateField = keyof Omit<ProfilePresetEx, "name" | "timestamp">;
...
export async function updatePresetField<K extends PresetUpdateField>(
    index: number,
    field: K,
    value: ProfilePresetEx[K],
