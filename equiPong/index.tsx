    ...
    patches: [
        {
            find: "emojiNode:t",
            replacement: {
                match: /onClick:(\i)=>\{(\i)\(!0\),(\i)\?\.onClick\?\.\(\1\)\}/,
                replace: "onClick:$1=>{$2(!0),$self.registerChatEmojiTap($1),$3?.onClick?.($1)}"
            }
        },
        {
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: "onClick:$self.chainEmojiClick(e?.onClick),\"data-type\":\"emoji\""
            }
        }
    ],
    start() {
